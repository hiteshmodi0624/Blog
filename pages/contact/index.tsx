...
const ContactPage=()=>{
    ...
    return (
        <form className="flex justify-center my-6" onSubmit={onSubmitHandler}>
            <Section className="w-1/2 bg-light-text-2 py-4 rounded-md px-4">
                <Heading text="How can I help you?" />
                <div className="grid grid-cols-2 gap-2 w-full">
                    <InputElement id="email" name="Your Email" setInputValue={setEmail} value={email.value}/>
                    <InputElement id="name" name="Your Name" setInputValue={setName} value={name.value}/>
                </div>
                <InputElement id="message" name="Your Message" textbox={true} setInputValue={setMessage} value={message.value}/>
